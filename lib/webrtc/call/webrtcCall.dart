...
class WebrtcCall extends StatefulWidget {
  ...
  final String host;
  WebrtcCall({required this.host});

  @override
  _CallSampleState createState() => _CallSampleState();
}

class _CallSampleState extends State<WebrtcCall> {
    ...
    webViewController
      ...
      ..addJavaScriptChannel(
        ...
        onMessageReceived: (JavaScriptMessage message) {
          ...
          //  webViewController.runJavaScript('fromAppToWeb("testflutter send")');
        },
      )
  ...
  void _connect(BuildContext context) async {
    _signaling ??= Signaling(widget.host, context, webViewController)
      ..connect();
